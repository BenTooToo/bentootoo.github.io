const translations = {
  zh: {
    ...
    "projects.emptyTitle": "松川七中同窗录",
    "projects.emptyBody": "虚拟现实解密（ARG），探索正常的班级回忆录背后的秘密……",
    "projects.emptyCta": "点击图片开始游戏 ↗",
    "projects.emptyLinkLabel": "进入《松川七中同窗录》解谜游戏",
    "blog.title": "个人博客",
    "blog.lede": "本2兔喜欢在这里发布自己的想法，或许他想要保存每一分钟的自我。",
    "blog.cardOneDate": "2026-06-20 / 哲学 / 技术",
    "blog.cardOneTitle": "AI 的反思",
    "blog.cardOneBody": "从 VIVA Tech 舞台上的 AI 歌声出发，追问人性、情感和不完美是否仍然不可取代。",
    "blog.cardTwoDate": "2026-06-09 / 哲学",
    "blog.cardTwoTitle": "选择与努力的伪命题",
    "blog.cardTwoBody": "第一篇文章已经接入博客思维导图，并通过细线连接到“哲学”节点。",
    "blog.cardThreeDate": "图谱",
    "blog.cardThreeTitle": "进入个人博客",
  ...
  en: {
    ...
    "projects.emptyTitle": "Matsukawa No. 7 Middle School Class Album",
    ...
    "projects.emptyLinkLabel": "Play the Matsukawa No. 7 Middle School Class Album puzzle game",
    ...
    "blog.cardTwoDate": "2026-06-09 / Philosophy",
    "blog.cardTwoTitle": "The False Choice Between Choice and Effort",
    "blog.cardTwoBody": "The first essay now lives in the blog mind map and connects to the Philosophy node.",
    "blog.cardThreeDate": "Map",
    "blog.cardThreeTitle": "Enter the Personal Blog",
  ...
  fr: {
    ...
    "projects.emptyTitle": "Album de classe du collège Matsukawa n° 7",
    ...
    "projects.emptyLinkLabel": "Jouer à l’énigme Album de classe du collège Matsukawa n° 7",
    ...
    "blog.cardTwoDate": "2026-06-09 / Philosophie",
    "blog.cardTwoTitle": "Le faux duel entre choix et effort",
    "blog.cardTwoBody": "Le premier texte est maintenant relié au noeud Philosophie dans la carte du blog.",
    "blog.cardThreeDate": "Carte",
    "blog.cardThreeTitle": "Entrer dans le blog personnel",
