const translations = {
  zh: {
    ...
    "blog.cardOneDate": "2026-06-09 / 哲学",
    "blog.cardOneTitle": "选择与努力的伪命题",
    "blog.cardOneBody": "第一篇文章已经接入博客思维导图，并通过细线连接到“哲学”节点。",
    "blog.cardTwoDate": "图谱",
    "blog.cardTwoTitle": "进入个人博客",
    "blog.cardTwoBody": "哲学、音乐、制作和技术会成为文章系统的类别连接点，未来的子类别也会从这里自然展开。",
    "contact.title": "联系我",
  ...
  en: {
    ...
    "blog.cardOneDate": "2026-06-09 / Philosophy",
    "blog.cardOneTitle": "The False Choice Between Choice and Effort",
    "blog.cardOneBody": "The first essay now lives in the blog mind map and connects to the Philosophy node.",
    "blog.cardTwoDate": "Map",
    "blog.cardTwoTitle": "Enter the Personal Blog",
    "blog.cardTwoBody": "Philosophy, music, making, and technology are the category nodes. Future subcategories can grow from them naturally.",
  ...
  fr: {
    ...
    "blog.cardOneDate": "2026-06-09 / Philosophie",
    "blog.cardOneTitle": "Le faux duel entre choix et effort",
    "blog.cardOneBody": "Le premier texte est maintenant relié au noeud Philosophie dans la carte du blog.",
    "blog.cardTwoDate": "Carte",
    "blog.cardTwoTitle": "Entrer dans le blog personnel",
    "blog.cardTwoBody": "Philosophie, musique, création et technologie deviennent les noeuds de catégorie, prêts à accueillir de futures sous-catégories.",
    "contact.title": "Contact",
